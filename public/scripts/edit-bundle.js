...
noteBodyInput.addEventListener('input', function (e) {
  var note = (0, _notes.updateNote)(noteId, {
    body: e.target.value
  });
  dateElement.textContent = (0, _views.generateLastEdited)(note.updatedAt);
...
var setFilters = function setFilters(updates) {
  if (typeof updates.serachText === 'string') filters.searchText = updates.serachText;
...
exports.updateNote = exports.sortNotes = exports.removeNote = exports.createNote = exports.getNotes = exports.loadNotes = undefined;
...
exports.initalizeEditPage = exports.generateLastEdited = exports.renderNotes = exports.generateNoteDom = undefined;
...
var initalizeEditPage = function initalizeEditPage(noteId) {
  var noteTitleInput = document.getElementById('note-title');
  var noteBodyInput = document.getElementById('note-body');
  var dateElement = document.getElementById('last-edited');
...
exports.initalizeEditPage = initalizeEditPage;
